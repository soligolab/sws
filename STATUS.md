...
**Last session**: 2026-05-17 (sessione 17: grid child mouse selection + LeftPanel collapsible tree + multi-selection common props panel + design-reference borders + full GridCellEditor child ObjectProps)
...
**Last commit**: `aeb205f feat: grid child mouse selection + collapsible object tree`
