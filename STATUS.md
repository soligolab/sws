...
**Last session**: 2026-05-17 (sessione 17: grid child mouse selection + collapsible tree + context-sensitive panel + resize handles)
...
**Last commit**: `67ddb6d feat: visual resize handles for selected objects`
