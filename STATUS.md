...
**Last session**: 2026-05-17 (sessione 17: grid child mouse selection + LeftPanel collapsible tree + multi-selection common props panel + design-reference borders + full GridCellEditor child ObjectProps + context-sensitive properties panel)
...
**Last commit**: `f510dbf feat: context-sensitive properties panel for grid/cell/child`
