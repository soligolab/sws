...
| Deployment | Always-on, the primary path | Companion service in the same container image — built in by default since 2026-08-24 on the aarch64 images (`--no-lvgl` to leave it out); never a fork of the runtime |
