...
| [2026-09-21-gestione-tag-oggetto-unico.md](2026-09-21-gestione-tag-oggetto-unico.md) | richiesta del maintainer, 21-09-2026 (rivista per strutture e array) | **seme — decisione** — i tag come oggetto unico, creato dove serve e al salvataggio, **insieme a strutture e array** (oggi il modello è solo scalare in tutto il runtime). Prima una sessione di plan approfondita |
