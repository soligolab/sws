...
| [2026-09-24-commutazione-display-via-dbus.md](2026-09-24-commutazione-display-via-dbus.md) | vincolo del maintainer, 24-09-2026 | **seme — decisione** — la commutazione web/LVGL è l'ultimo meccanismo a file sull'host (`sws-display.path` + uno script di ~200 righe), lo stesso disegno che il vincolo «nell'host non puoi toccare nulla» ha appena eliminato per l'immagine di accensione. Misurato: delle quattro azioni dello script una è già D-Bus di sistema e due lo diventano senza toccare il quadlet; la terza vuole il bus utente, oggi non montato. Da decidere se montarlo |
| [2026-09-25-trasparenza-luminosita-e-forme.md](2026-09-25-trasparenza-luminosita-e-forme.md) | tentativo del maintainer, 25-09-2026 | **seme — decisione** — trasparenza e luminosità come proprietà legabili a un tag, per ottenere un lampeggio *fade* invece dell'acceso/spento di oggi; più polilinea e un generatore di poligoni in «Shapes». Tocca 36 tipi, due motori di rendering e l'inventario dei campi: su LVGL l'opacità esiste, i filtri di luminosità no |
...
| [2026-09-26-storico-troppo-grande.md](2026-09-26-storico-troppo-grande.md) | richiesta del maintainer, 26-09-2026 | **seme — decisione** — lo storico di CasaDomotica pesa ~590 MB in 27 giorni: 7 milioni di campioni su 73 tag (in `project.yaml` `history: true` sono 20), valori quasi costanti registrati ogni 2-5 s, campione in JSON testuale. E ogni backup automatico ne copia il file intero (3,2 GB in 7 backup) |
