...
| [2026-09-15-multilingua-di-progetto.md](2026-09-15-multilingua-di-progetto.md) | **IN CORSO — Fase 0** | otto fasi: rete di test e guardia di parità (0), un solo imbuto e i campi mancanti (1), allarmi e notifiche (2), la chiave che nasce da sola (3), traduzione automatica (4), lingua e bandiere (5), script Python (6), template (7) |
