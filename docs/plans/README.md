...
| [2026-09-23-un-allarme-per-tag-con-piu-condizioni.md](2026-09-23-un-allarme-per-tag-con-piu-condizioni.md) | idea del maintainer, 23-09-2026 | **seme — decisione** — un tag si aggancia a **un solo** allarme, che dentro ha più condizioni, e a ogni valutazione ne vince una sola secondo una priorità da definire. Oggi si dichiarano N allarmi sullo stesso tag e scattano **tutti insieme**: con soglie 60/70/80 e il tag a 85 il runtime ne tiene tre attivi per un solo fenomeno, e la notifica parte tre volte. Misurato: **otto progetti su tredici** hanno già più allarmi sullo stesso tag, quindi serve una migrazione automatica |
