...
| [2026-09-15-multilingua-di-progetto.md](2026-09-15-multilingua-di-progetto.md) | **IN CORSO — fasi 0-4 fatte, ramo `feat/multilingua` non mergiato** | restano la 5 (bandiere via `bg_image` su LVGL, persistenza della lingua sul pannello, intestazioni cablate del viewer), la 6 (`tr()` negli script Python) e la 7 (template). Le fasi 0-4 sono su ramo e collaudate a mano dal maintainer il 15-09; il collaudo ha trovato quattro difetti, tutti corretti |
...
| [2026-09-16-T71-selettore-caratteri.md](2026-09-16-T71-selettore-caratteri.md) | **IN CORSO** | T-71: selettore di caratteri/emoji per i campi di testo, con le emoji vere anche su LVGL (font Noto Emoji in fallback). Tre fasi in sequenza: B (font+fallback su LVGL), A (protezione dalla traduzione automatica), C (selettore nell'editor) — un ramo alla volta |
