...
| [2026-09-21-gestione-tag-oggetto-unico.md](2026-09-21-gestione-tag-oggetto-unico.md) | richiesta del maintainer, rivisto 22-09-2026 dopo sessione di plan approfondita | **piano a fasi (da avviare)** — tag come oggetto unico (Fase 0: registro riferimenti, creazione al salvataggio, rinomina/cancellazione, server coerente), poi TagValue composito nativo (Fase 1), editor con tipi/istanze (Fase 2), Modbus e OPC-UA (Fasi 3-4); S7/EtherNet-IP/MQTT/HA/Host in coda. Un ramo alla volta, si parte da `feat/tag-0a-registro-riferimenti` |
