...
| [2026-09-21-gestione-tag-oggetto-unico.md](2026-09-21-gestione-tag-oggetto-unico.md) | richiesta del maintainer, 21-09-2026 | **seme — decisione** — i tag come oggetto unico, creato dove serve e al salvataggio; oggi tabella variabili e riferimenti non si parlano (creazione a mano con «+var», nessun avviso su un id inesistente). Prima una sessione di plan approfondita |
