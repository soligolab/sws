...
**In corso** (24-09-2026): [configurazione ad albero, e ConfigView diviso in file](2026-09-24-configurazione-ad-albero-piano.md) — piano a quattro passi (registro unico delle schede, `ConfigView.tsx` diviso per scheda, vista ⚙ nel pannello sinistro portato a livello di App, foglie di secondo livello), nato dalla sessione di plan sui due semi del 22-09. Il resto sono **semi**, non piani d'esecuzione: ognuno va aperto con una sessione di plan approfondita prima di scrivere codice.
