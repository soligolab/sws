...
| [2026-09-21-gestione-tag-oggetto-unico.md](2026-09-21-gestione-tag-oggetto-unico.md) | richiesta del maintainer, rivisto 22-09-2026 dopo sessione di plan approfondita | **piano a fasi (in corso)** — tag come oggetto unico (Fase 0: **0a registro riferimenti fatto**, `b2d01098`; **0b creazione al salvataggio e Salva unico fatto**, `6c5cc2c3`; 0c rinomina/cancellazione, 0d server coerente da fare), poi TagValue composito nativo (Fase 1), editor con tipi/istanze (Fase 2), Modbus e OPC-UA (Fasi 3-4); S7/EtherNet-IP/MQTT/HA/Host in coda. Un ramo alla volta, prossimo `feat/tag-0b-creazione-al-salvataggio` |
