...
**Nessun piano d'esecuzione in corso** (25-09-2026): l'ultimo, la configurazione ad albero, è finito ed è in [archivio](../archive/2026-09-24-configurazione-ad-albero-piano.md). Il resto sono **semi**, non piani d'esecuzione: ognuno va aperto con una sessione di plan approfondita prima di scrivere codice.
