# STATUS — le sessioni di luglio e agosto 2026, integrali

> Spostate qui da `STATUS.md` il 2026-09-06: 2.800 righe di sessioni **mergiate e verificate**
> coprivano il 70% del file e nascondevano quello che è ancora da fare. Qui non si è riassunto
> niente: i blocchi sono interi, nell'ordine in cui stavano (circa dal più recente al più vecchio).
> In `STATUS.md` resta una riga per sessione nella sezione «Storico».
>
> Le ~76 voci del blocco «Release 2.1.0» erano paragrafi in grassetto senza intestazioni markdown,
> quindi invisibili a ogni sommario: qui sono diventate `###`, il testo è invariato.
...
Piano completo: `docs/archive/2026-09-01-editor-runtime.md`.*
...
`docs/archive/2026-09-01-editor-runtime.md`. Resta anche da lanciare la prova end-to-end della chat
...
**Analizzato e pianificato il 2026-09-04**: `docs/archive/2026-09-04-limite-pagina-morbido.md`.
...
`docs/archive/2026-08-06-audit-widget-e-codice.md` (proposte non implementate: BindableInput
...
ESP32) in `docs/archive/2026-08-07-lvgl-engine.md`.~~
...
**documentato, non implementato** — vedi `docs/archive/2026-08-06-audit-widget-e-codice.md`.
...
`docs/archive/2026-07-31-installa-da-registry.md`, copiato lì apposta perché quelli in
...
### Punto di partenza — chiusura del 2026-09-04 (l'intro, superata dai push del 2026-09-06)

`origin/main` era a `97ffff1` (release 2.5.0, tag su origin); restavano da pushare `7ae531f` e
`342d609`, poi pushati. Conservata qui perché la sezione viva descriveva uno stato di quel giorno.
