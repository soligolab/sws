...
pub struct SynopticPage {
    ...
    /// the same endpoint.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub auto_rotate_skip: Option<bool>,
...
pub struct SynopticObject {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub release_value: Option<Value>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub checked_value: Option<Value>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub unchecked_value: Option<Value>,
    // Navigation
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub trend_series_styles: Option<Value>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub table_columns: Option<Value>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub on_press_args: Option<Value>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub on_release_args: Option<Value>,
    // Text object styling
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub font_weight: Option<Value>, // string ("bold") or number (700)
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub button_action: Option<Value>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub alarm_viewer_severities: Option<Value>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub alarm_bell_severities: Option<Value>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub alarm_banner_severities: Option<Value>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub faceplate_params: Option<Value>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub faceplate_scale: Option<bool>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub faceplate_overrides: Option<Value>,
    // Text list (type === "text_list") — same pre-existing gap.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub text_list_entries: Option<Value>,
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl SynopticObject {
    ...
    fn punti(&self) -> Vec<(f64, f64)> {
        let Some(v) = self.points.as_ref().and_then(|p| p.as_array()) else {
            return Vec::new();
        };
        v.iter()
...
mod tests_fuori_pagina {
    ...
    fn pagina(w: Option<f64>, h: Option<f64>) -> SynopticPage {
        let mut p: SynopticPage = serde_json::from_str(
            r#"{"id":"p","name":"P","objects":[],"background":null,"background_dark":null}"#,
        )
