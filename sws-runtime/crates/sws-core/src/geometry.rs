...
// La tabella è dati, non codice: una riga per caso, colonne allineate, così un
// caso nuovo si legge e si confronta a colpo d'occhio con la copia TypeScript.
// `cargo fmt` la spezzerebbe in dieci righe per riga — e la guardia
// `scripts/check_off_page.sh`, che la legge con un'espressione regolare, ha
// smesso di trovarla il 2026-09-09, dopo il `cargo fmt` di tutto il workspace.
#[rustfmt::skip]
